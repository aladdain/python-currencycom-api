...
class CurrencyComConstants(object):
    ...
    # https://api-adapter.backend.currency.com/api/{}/
    # https://demo-api-adapter.backend.currency.com
...
class Client(object):
    ...
    def __init__(self, api_key:str='', api_secret:str='', demo:bool=False):
        ...
        self.demo = demo
        self.base_url = 'https://api-adapter.backend.currency.com/api/{}/'.format(
            CurrencyComConstants.API_VERSION
        )
        if demo:
            self.base_url = 'https://demo-api-adapter.backend.currency.com/api/{}/'.format(
                CurrencyComConstants.API_VERSION
            )
    ...
    def get_account_info(self, recv_window=None):
        ...
        r = self._get(self.base_url + CurrencyComConstants.ACCOUNT_INFORMATION_ENDPOINT,
    ...
    def get_agg_trades(self, symbol,
        ...
        r = requests.get(self.base_url + CurrencyComConstants.AGGREGATE_TRADE_LIST_ENDPOINT,
                         params=params)
    ...
    def close_trading_position(self, position_id, recv_window=None):
        ...
        r = self._post(
            self.base_url + CurrencyComConstants.CLOSE_TRADING_POSITION_ENDPOINT,
    ...
    def get_order_book(self, symbol, limit=100):
        ...
        r = requests.get(self.base_url + CurrencyComConstants.ORDER_BOOK_ENDPOINT,
                         params={'symbol': symbol, 'limit': limit})
        return r.json()
    ...
    def get_exchange_info(self):
        ...
        """
        r = requests.get(self.base_url + CurrencyComConstants.EXCHANGE_INFORMATION_ENDPOINT)
        return r.json()
    ...
    def get_klines(self, symbol,
        ...
        if end_time:
            params['endTime'] = self._to_epoch_miliseconds(end_time)
        r = requests.get(self.base_url + CurrencyComConstants.KLINES_DATA_ENDPOINT,
                         params=params)
        return r.json()
    ...
    def get_leverage_settings(self, symbol, recv_window=None):
        ...
        r = self._get(
            self.base_url + CurrencyComConstants.LEVERAGE_SETTINGS_ENDPOINT,
            symbol=symbol,
            recvWindow=recv_window
        )
        return r.json()
    ...
    def get_account_trade_list(self, symbol,
        ...
        r = self._get(self.base_url + CurrencyComConstants.ACCOUNT_TRADE_LIST_ENDPOINT,
                      **params)
    ...
    def get_open_orders(self, symbol=None, recv_window=None):
        ...
        r = self._get(self.base_url + CurrencyComConstants.CURRENT_OPEN_ORDERS_ENDPOINT,
                      symbol=symbol,
                      recvWindow=recv_window)
        return r.json()
    ...
    def new_order(self,
        ...
        r = self._post(
            self.base_url + CurrencyComConstants.ORDER_ENDPOINT,
    ...
    def get_24h_price_change(self, symbol=None):
        ...
        """
        r = requests.get(self.base_url + CurrencyComConstants.PRICE_CHANGE_24H_ENDPOINT,
    ...
    def get_server_time(self):
        ...
        """
        r = requests.get(self.base_url + CurrencyComConstants.SERVER_TIME_ENDPOINT)
    ...
    def list_leverage_trades(self, recv_window=None):
        ...
        self._validate_recv_window(recv_window)
        r = self._get(
            self.base_url + CurrencyComConstants.TRADING_POSITIONS_ENDPOINT,
            recvWindow=recv_window
        )
        return r.json()
    ...
    def update_trading_position(self,
        ...
        self._validate_recv_window(recv_window)
        r = self._post(
            self.base_url + CurrencyComConstants.UPDATE_TRADING_POSITION_ENDPOINT,
            positionId=position_id,
            guaranteedStopLoss=guaranteed_stop_loss,
            stopLoss=stop_loss,
            takeProfit=take_profit
